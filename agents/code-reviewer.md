...
2. **Invoke `agent-skills:code-review-and-quality`** for structured multi-axis review guidance. Use `agent-skills:code-simplification` to identify simplification opportunities.
